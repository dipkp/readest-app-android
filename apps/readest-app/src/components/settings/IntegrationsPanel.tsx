  ...
  if (subPage === 'readest-cloud')
    return (
      <div className='my-4 w-full'>
        <SubPageHeader
          parentLabel={_('Integrations')}
          currentLabel={_('DOD Cloud')}
          description={_('Sync your library, reading progress, and highlights with DOD Cloud.')}
          onBack={() => setSubPage(null)}
        />
        <BoxedList>
          <NavigationRow
    ...
    <div className='my-4 w-full space-y-6'>
      <div className='w-full px-4'>
        ...
        <p className='text-base-content/70 text-sm leading-relaxed'>
          {_('Connect DOD to external services for sync, highlights, and catalogs.')}
        </p>
      </div>
