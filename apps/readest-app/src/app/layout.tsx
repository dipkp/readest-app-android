...
const title = 'DOD — Where You Read, Digest and Get Insight';
const description =
  'Discover DOD, the ultimate online ebook reader for immersive and organized reading. ' +
...
export const metadata: Metadata = {
  ...
  keywords: ['epub', 'pdf', 'ebook', 'reader', 'dod', 'pwa'],
  authors: [],
  icons: {
