...
describe('sanitizeSettingsForBackup - credentials', () => {
  it('strips credentials by default', () => {
    ...
    expect(rec(out.aiSettings)['geminiApiKey']).toBeUndefined();
    expect(rec(out.aiSettings)['groqApiKey']).toBeUndefined();
    expect(rec(out.aiSettings)['openrouterApiKey']).toBeUndefined();
    expect(rec(out.globalViewSettings)['deeplApiKey']).toBeUndefined();
  ...
  it('keeps credentials when includeCredentials is true', () => {
    ...
    expect(rec(out.aiSettings)['geminiApiKey']).toBe('ai-secret-key');
    expect(rec(out.aiSettings)['groqApiKey']).toBe('groq-secret-key');
    expect(rec(out.aiSettings)['openrouterApiKey']).toBe('or-secret-key');
    expect(rec(out.globalViewSettings)['deeplApiKey']).toBe('deepl-secret-key');
